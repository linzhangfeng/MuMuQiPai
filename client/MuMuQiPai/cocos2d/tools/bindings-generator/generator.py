...
def main():
    ...
    userconfig.read('/Users/linzhangfeng/Desktop/linzhangfeng/svn/MuMuQiPai/client/MuMuQiPai/jsbind/userconf.ini')
    ...
    print 'Using config sections...\n ', config.sections()
    print 'Using config opts...\n ', opts
